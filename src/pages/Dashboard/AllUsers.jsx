...
const AllUsers = () => {
    ...
    const handleMakeAdmin = (user) => {
        console.log(user);
        fetch(`https://assignment12-server-nahidahmmed.vercel.app/users/admin/${user._id}`, {
            method: 'PATCH'
        })
            .then(res => res.json())
            .then(data => {
    ...
    const handleMakeInstructor = (user) => {
        fetch(`https://assignment12-server-nahidahmmed.vercel.app/users/instructor/${user._id}`, {
            method: 'PATCH'
        })
            .then(res => res.json())
            .then(data => {
