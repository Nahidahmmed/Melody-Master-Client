...
const SliderSection = () => {
    return (
        ...
        >
            <SwiperSlide>
                <img className="w-[2000px] h-[700px]" src={violin} alt="" />
                <div className="-mt-80 text-left p-32 text-white font-semibold w-2/3">
            ...
            <SwiperSlide>
                <img className="w-[2000px] h-[700px]" src={drum} alt="" />
                <div className="-mt-80 text-left p-32 text-white font-semibold w-2/3">
            ...
            <SwiperSlide>
                <img className="w-[2000px] h-[700px]" src={flute} alt="" />
                <div className="-mt-80 text-left p-32 text-white font-semibold w-2/3">
            ...
            <SwiperSlide>
                <img className="w-[2000px] h-[700px]" src={getter} alt="" />
                <div className="-mt-80 text-left p-32 text-white font-semibold w-2/3">
            ...
            <SwiperSlide>
                <img className="w-[2000px]" src={Trumpet} alt="" />
                <div className="-mt-80 text-left p-32 text-white font-semibold w-2/3">
