export default function ThankYou() {
  return (
    <div className="CARD mx-auto mt-12">
      <div className="relative bg-black w-[400px] lg:w-[650px] group transition-all duration-700 aspect-video flex items-center justify-center">
        <div className="transition-all flex flex-col items-center py-5 justify-start duration-300 group-hover:duration-1000 bg-white w-full h-full absolute group-hover:-translate-y-16 group-hover:border-[3px]">
          ...
          <p className="px-10 text-[10px] sm:text-[12px] text-gray-700">
            It’s so nice that you had the time to view my website.
          </p>
          <p className="font-serif text-[10px] sm:text-[12px text-gray-700">
            Wishing you a fantastic day ahead!
          </p>
          <p className="font-sans text-[15px] text-gray-700 pt-5">Kamrul Zaman Nahid</p>
        </div>
