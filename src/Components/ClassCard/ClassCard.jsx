...
const ClassCard = ({ item }) => {
  ...
  return (
    <div>
      {/* <div className="main">
        <div className="card_body" style={{backgroundImage: `url(${item.image})` , backgroundSize: 'cover'}}>
          <div className="fl">
          ...
          <div className="card_content">
            <label className="switch_738"></label>
          </div>
          <div className="card_back"></div>
        </div>
        <div className="data">
          
          <div className="img" style={{backgroundImage: `url(${item.image})` , backgroundSize: 'cover'}}></div>
          <div className="text">
            <div className="text_m">{item.name}</div>
      ...
      <div className=" rounded w-[400px]  shadow-lg">
      <img className="w-full h-[300px]" src={item.image} alt="card-image" />
      <div className="px-6 py-4">
        <div className="font-bold text-xl mb-2 text-blue-500">UI/UX Review Check</div>
